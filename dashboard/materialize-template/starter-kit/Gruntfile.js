module.exports = function(grunt) {
  ...
  'use strict';
  global.appLayout = grunt.option('layout') || "semi-dark-menu"; // layout name

  // write custome selected theme.scss file which will import in style.scss and materialize.scss
  grunt.file.write('sass/theme.scss', '@import "themes/' + appLayout + '/theme";');
  ...
  grunt.initConfig({
    ...
    sass: {
      main: {
        ...
        files: {
          ['css/themes/'+appLayout+'/materialize.css']: 'sass/materialize.scss',
          ['css/themes/'+appLayout+'/style.css']: 'sass/style.scss',
      ...
      dist: {
        ...
        files: {
          ['css/themes/'+appLayout+'/materialize.min.css']: 'sass/materialize.scss',
          ['css/themes/'+appLayout+'/style.min.css']: 'sass/style.scss',
    ...
    postcss: {
      ...
      main: {
        files: {
          ...
          ['css/themes/'+appLayout+'/style.css']: 'css/themes/'+appLayout+'/style.css',
