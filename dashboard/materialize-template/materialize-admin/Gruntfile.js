module.exports = function(grunt) {
  ...
  'use strict';
  global.layout = grunt.option('layout') || "semi-dark-menu" // layout name

  // write custome selected theme.scss file which will import in style.scss and materialize.scss
  grunt.file.write('sass/theme.scss', '@import "themes/' + global.layout + '/theme";');
  ...
  grunt.initConfig({
    ...
    sass: {
      main: {
        ...
        files: {
          ['css/themes/'+layout+'/materialize.css']: 'sass/materialize.scss',
          ['css/themes/'+layout+'/style.css']: 'sass/style.scss',
      ...
      dist: {
        ...
        files: {
          ['css/themes/'+layout+'/materialize.min.css']: 'sass/materialize.scss',
          ['css/themes/'+layout+'/style.min.css']: 'sass/style.scss',
    ...
    postcss: {
      ...
      main: {
        files: {
          ...
          ['css/themes/'+layout+'/style.css']: 'css/themes/'+layout+'/style.css',
